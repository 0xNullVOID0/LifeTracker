...
public sealed class DailyHeartRateDTO
{
    ...
    [JsonPropertyName("minHeartRate")] public int MinHeartRate { get; set; }

    [JsonPropertyName("maxHeartRate")] public int MaxHeartRate { get; set; }
    ...
    [JsonPropertyName("heartRateValues")] public List<long?[]>? HeartRateValues { get; set; }
}
